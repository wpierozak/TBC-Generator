...
enum class MsFileForamt{xyz, xyzrgb};
...
class GeneratorConfig
{
    ...
    MsFileForamt getMsFileFormat() const { return _msFileFormat; }
    ...
    void setMsFileFormat(MsFileForamt ms) { _msFileFormat = ms; }
